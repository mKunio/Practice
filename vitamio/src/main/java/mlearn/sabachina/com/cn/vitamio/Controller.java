...
/**
 * Created by zhc on 2017/10/16 0016.
 */
...
public class Controller extends FrameLayout {
    ...
    private io.vov.vitamio.widget.MediaController.MediaPlayerControl mPlayer;
    ...
    private io.vov.vitamio.widget.MediaController.OnShownListener mShownListener;
    private io.vov.vitamio.widget.MediaController.OnHiddenListener mHiddenListener;
    ...
    public void setMediaPlayer(io.vov.vitamio.widget.MediaController.MediaPlayerControl player) {
        mPlayer = player;
        updatePausePlay();
    }
    ...
    public void show(int timeout) {
        if (!mShowing && mAnchor != null && mAnchor.getWindowToken() != null) {
            ...
            if (mFromXml) {
                ...
                mWindow.showAtLocation(mAnchor, Gravity.TOP, 0, mAnchor.getHeight()+statusBarHeight);
            }
            mShowing = true;
    ...
    public void setOnShownListener(io.vov.vitamio.widget.MediaController.OnShownListener l) {
        mShownListener = l;
    }

    public void setOnHiddenListener(io.vov.vitamio.widget.MediaController.OnHiddenListener l) {
        mHiddenListener = l;
    }
